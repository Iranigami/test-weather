<template>
  <div class="w-[510px] mx-auto mt-[26px]">
    <div>
      <img src="/assets/icons/Arrow.svg" class="w-[38px] h-[32px] ml-[128px] mb-[-17px]"/>
    ...
    <div class="mt-[88px] justify-center">
      ...
      <img class="mt-[20px] mx-auto" src="/assets/icons/Bookmark.svg"/>
    </div>
  </div>
</template>